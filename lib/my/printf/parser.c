...
static flag_t *initialize_flag_t(void)
{
    ...
    flag->flag_str = NULL;
    flag->is_good = 1;
    flag->flag_struct = malloc(sizeof(flag_struct_t));
    flag->flag_struct->has_hyphen = 0;
    flag->flag_struct->has_plus = 0;
    flag->flag_struct->has_space = 0;
    flag->flag_struct->has_hashtag = 0;
    flag->flag_struct->has_zero = 0;
    flag->flag_struct->field_width = DEFAULT_FIELD_WIDTH;
    flag->flag_struct->precision = DEFAULT_PRECISION;
    flag->flag_struct->is_precision_specified = 1;
    flag->flag_struct->length_modifier = NULL;
    flag->flag_struct->conversion_specifier = '\0';
    return flag;
}
